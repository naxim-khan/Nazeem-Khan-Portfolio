    ...
    return <>
       <div className="blogpage">
            <div className="titledashboard flex flex-sb">
                <h2>All Drafts <span>Products</span></h2>
                <h3>ADMIN PANEL</h3>
            </div>
            <div className="breadcrumb">
                <BiLogoBlogger /> <span>/</span><span>Products / Drafts</span>
            </div>

            <div className="blogstable">
                <div className="flex gap-2 mb-1">
                    <h2>Search Draft Products:</h2>
                    ...
                    <tbody>
                        {loading ? <>
                            ...
                            {publishedblogs.length === 0 ?(
                                <tr>
                                    <td colSpan={4} className="text-center">NO Drafts Products Found...! <ImConfused /></td>
                                </tr>
                            ) : (
