...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Integrated RESTful and GraphQL APIs into front-end applications for smooth data flow and dynamic content.",
  ...
  },
  {
    ...
    desc: "Delivered complete web solutions by combining front-end, back-end, and database expertise to meet client needs.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
