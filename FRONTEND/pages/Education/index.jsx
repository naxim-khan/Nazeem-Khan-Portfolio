...
export default function shop() {
    ...
    return <>
        ...
        {/* <section className="hero max-w-[1300px] flex-col bg-black-100 dark:bg-[#dedddc] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 py-10 mt-8 px-4 max-md:py-0 items-center justify-center max-sm:min-w-auto">
            <Particles className="absolute w-screen h-screen top-0 bottom-0 dark:text-black-100" quantity={100} size={0.6} />
           
                <div className="toptitleedu ">
                    <div className="toptitlecontedu flex_css dark:text-black-100 max-md:pb-0 pb-8 md:items-start items-center">
                        <h1>Achievements & <br /><span>Certifications</span></h1>
                        <p className=" text-start max-md:text-center dark:text-slate-700">I'm a final-semester Computer Science student at the University of Peshawar with expertise in programming, Web development, and MERN stack. I also hold a Diploma in IT and completed Full-Stack Web Development courses, preparing me for success in tech.</p>
                ...
                <div className="py-10">
                    <div className="container_css bg-black-100 dark:bg-[#dedddc] mt-8">
        ...
        {/* hero section */}
        <section className="max-w[1300px] bg-black-100 dark:bg-[#dedddc] ">
        <Particles className="absolute w-screen h-screen top-0 bottom-0 dark:text-black-100" quantity={100} size={0.6} />

            <div className="container_css px-2 sm:px-8">
