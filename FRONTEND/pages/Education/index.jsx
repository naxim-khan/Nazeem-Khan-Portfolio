...
export default function shop() {
    ...
    return <>
        ...
        <section className="topheroeducation bg-black-100 dark:bg-[#dedddc]">
            <Particles className="absolute w-screen h-screen top-0 bottom-0 dark:text-black-100" quantity={100} size={0.6} />

            <div className="container_css">
                <div className="toptitleedu grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 py-10 mt-8 px-4 max-md:py-0 items-center justify-center max-sm:min-w-auto">
